document.addEventListener('DOMContentLoaded', () => {
    const documents = Object.freeze({
        ...
        'brain-egg-overview': ['怪奇之原 · 玩法与功能说明', 'brain-egg-overview.txt?v=20260902-brain-egg-v191', '怪奇之原-玩法说明.txt'],
        'brain-egg-changelog': ['怪奇之原 · 版本记录', 'brain-egg-changelog.txt?v=20260902-brain-egg-v191', '怪奇之原-版本记录.txt'],
