document.addEventListener('DOMContentLoaded', () => {
    const documents = Object.freeze({
        ...
        'gpt-roadmap': ['0.015B 自研模型 · Roadmap', '/project-docs/gpt-roadmap.txt?v=20260831-utf8-bom-v1', '0.015B自研模型-Roadmap.txt'],
        'gpt-record': ['0.015B 自研模型 · 学习记录', '/project-docs/gpt-record.txt?v=20260831-utf8-bom-v1', '0.015B自研模型-学习记录.txt'],
